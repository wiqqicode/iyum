        ...
        <div class="header-title">
            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    <div class="col-lg-12 clearfix" style="margin-left: 5%;">
                        ...
                        <ul class="top-header-nav list-unstyled thn-end" >
                            ...
                            <li class="cs-nav c-nav col-lg-2 h-25 d-inline-block">
                                 <form name="frmsearch1" action="<?php echo G5_SHOP_URL; ?>/search.php" onsubmit="return search_submit(this);" class="eyoom-form">
                                    ...
                                    <div class="input input-button form search-form" >
                                        <input type="text" name="q" value="<?php echo stripslashes(get_text(get_search_string($q))); ?>" id="search_input" class="sch_stx rounded form-group" placeholder="상품 검색어 입력" style="">
                                        <div class="button form-group search-btn">
                                            <input type="submit" class="rounded srch-btn">
                                            <i class="fas fa-search" style="color: white; position: absolute;"></i>
                                        </div>
                                    </div>
